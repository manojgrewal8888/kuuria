                ...
                <div className="wrapnom_umb">
                    <div className="wrapinner_nom">
                        ...
                        <div className="flex_umb">
                            <div className="item_umb"><Link  className="link_reset" exact to='/voting' ><p className="nom_subumb"> Nominee 1</p></Link></div>
                            <div className="item_umb"><Link className="link_reset"  exact to='/voting' ><p className="nom_subumb"> Nominee 2</p></Link></div>
                            <div className="item_umb"><Link className="link_reset"  exact to='/voting' ><p className="nom_subumb"> Nominee 3</p></Link></div>
                            <div className="item_umb"><Link className="link_reset"  exact to='/voting' ><p className="nom_subumb"> Nominee 1</p></Link></div>
                            <div className="item_umb"><Link className="link_reset"  exact to='/voting' ><p className="nom_subumb"> Nominee 2</p></Link></div>
                            <div className="item_umb"><Link className="link_reset"  exact to='/voting' ><p className="nom_subumb"> Nominee 3</p></Link></div>
                        </div>
